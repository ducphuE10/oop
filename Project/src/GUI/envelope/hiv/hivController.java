...
public class hivController extends GeneralVirusController implements Initializable {
    ...
    void showGp120(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Gp120);

    }

    @FXML
    void showGp41(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Gp41);

    }

    @FXML
    void showHumanClass1(ActionEvent event) {
        textExplain.setText(Main.hivVirus.HumanClass1);

    }

    @FXML
    void showHumanClass2(ActionEvent event) {
        textExplain.setText(Main.hivVirus.HumanClass2);
    }

    @FXML
    void showIntegrase(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Integrase);

    }

    @FXML
    void showLipidBilayer(ActionEvent event) {
        textExplain.setText(Main.hivVirus.envelopeOfVirus.getEnvelopeOfVirus());

    }

    @FXML
    void showMatrixProtein(ActionEvent event) {
        textExplain.setText(Main.hivVirus.MatrixProtein);
    ...
    void showNucleocapsid(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Nucleocapsid);
    ...
    void showProtease(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Protease);

    }

    @FXML
    void showProteinP79(ActionEvent event) {
        textExplain.setText(Main.hivVirus.ProteinP79);

    }

    @FXML
    void showRNA(ActionEvent event) {
        textExplain.setText(Main.hivVirus.RNA);
    ...
    void showReverse(ActionEvent event) {
        textExplain.setText(Main.hivVirus.Reverse);
